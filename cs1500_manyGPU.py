...
print('CS problem at multiple gpu, grid size of 1,500')
print('\n----------------')
...
print(concat_gpu[nparams+ 10*1500*15:(nparams+ 10*1500*15 + 30)])
...
for lap in range(10):
    ...
    for age in range(T-1, -1, -1):
        ...
        for gpu_idx in range(len(cuda.gpus)):
            ...
            #########################TODO#################################
            ### print intermediate versions of the value function
            # memory cleaning?
            ##############################################################
